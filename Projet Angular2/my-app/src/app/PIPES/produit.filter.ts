...
export class PrixCleProduit implements PipeTransform{
    ...
    transform(value: any, ...args: any[]): any { // utilisation methode transform dans la classe ItemPipe
       // console.log(value);
        ...
        return filtre ? value.filter(produitFiltre => produitFiltre.designation.toLowerCase().indexOf(filtre) != -1) : value; // fonction filter() de javascript
    }
}